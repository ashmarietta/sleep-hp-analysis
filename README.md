# Sleep and Human Performance Analysis

This is a reproducible analysis built from self-tracked sleep and performance data. The project evaluates how sleep duration, caffeine intake, and daily routines impact morning alertness and productivity over time.
The analysis consolidates daily observations into visualizations and insights that highlight key drivers of performance in a real-world setting.
...
- Expand dataset across multiple individuals
